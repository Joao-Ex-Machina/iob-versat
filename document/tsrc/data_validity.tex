...
\begin{lstlisting}[language=VersatSpec,caption={Versat automatically balances the two paths reaching \texttt{sum}.},label={lst:validity_example}]
...
\begin{lstlisting}[language=VersatSpec,caption={Explicit delay operator \texttt{\{N\}} combining values from different cycles.},label={lst:delay_example}]
module DelayExample(){
  Mem mem;
#
